...
public class BrowserUtils {
     ...
     * @param time
     */
    public static void waitForPresenceOfElement(WebElement webElement, String text, long time) {
        new WebDriverWait(Driver.get(), time).until(ExpectedConditions.textToBePresentInElement(webElement,text));
    }
